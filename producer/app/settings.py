...
# Load environment variables from producer microservice .env file
...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-k685p!d5%^72fup*%96=xhz!=yr$wuqh7k96gt@x8b6")
